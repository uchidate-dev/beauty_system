        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-8 mb-8">
                ...
                <div class="flex justify-between items-end mb-8 border-b border-gray-100 pb-4">
                    <div
                        class="flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4 mb-8 border-b border-gray-100 pb-4">
                        <h3 class="text-base sm:text-lg font-light tracking-widest text-gray-800">RESERVATIONS / 予約一覧
                        </h3>

                        {{-- 予約がある場合のみ、右上の小さい新規予約ボタンを表示 --}}
                        @if (!$upcomingReservations->isEmpty())
                            <a href="{{ route('reservations.index') }}"
                                class="w-full sm:w-auto text-center text-[10px] whitespace-nowrap shrink-0 border border-gray-800 px-4 py-2 sm:px-4 sm:py-2 hover:bg-gray-800 hover:text-white transition-all duration-300">
                                NEW BOOKING / 新規予約
                            </a>
                        @endif
                    </div>
                    ...
                    @else
                        ...
                        <div class="space-y-6">
                            @foreach ($upcomingReservations as $reservation)
                                <div
                                    class="group border border-gray-100 p-6 hover:border-gray-300 transition-all bg-white">
                                        ...
                                        <div class="text-right" x-data="{ open: false }">
                                            ...
                                            @else
                                                ...
                                                <div class="mt-2 border-t border-gray-100 pt-3">
                                                    <p
                                                        class="text-[10px] text-gray-400 tracking-widest leading-relaxed">
                    ...
                    @else
                        <div class="grid grid-cols-1 gap-4 opacity-70">
                            @foreach ($pastReservations as $reservation)
                                <div
                                    class="p-5 border-l-2 border-gray-200 bg-gray-50/50 flex justify-between items-center">
                                    <div>
