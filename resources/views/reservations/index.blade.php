    ...
    <div class="py-12 bg-[#fafafa]">
        <div class="max-w-5xl mx-auto px-5 sm:px-6 lg:px-8">
                ...
                <form action="{{ route('reservations.datetime') }}" method="GET">
                        ...
                        @foreach ($menus as $menu)
                            <label
                                ...
                                <div class="flex justify-between items-start">
                                    ...
                                    <p class="text-sm font-semibold text-gray-900">¥{{ number_format($menu->price) }}
                                    </p>
                                </div>
                            </label>
                        @endforeach
                    ...
                    <div x-data="{ selectedStaff: null }" class="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 mb-20">
                        ...
                        <label class="group relative cursor-pointer text-center">
                            <input type="radio" name="staff_id" value="0" x-model="selectedStaff"
            ...
            peer-checked:bg-gray-700 peer-checked:ring-2 peer-checked:ring-black peer-checked:ring-offset-2 shadow-md">
                            ...
                            <p class="text-[10px] text-gray-400 mt-1 px-1 italic leading-tight">No designated stylist
                            </p>
                        </label>
                        ...
                        @foreach ($staffs as $staff)
                            <label class="group relative cursor-pointer text-center block">
                                <input type="radio" name="staff_id" value="{{ $staff->id }}"
                                    x-model="selectedStaff" class="hidden peer" required>
                    ...
                    peer-checked:text-black peer-checked:tracking-[0.25em]">
                                ...
                                <div
                                    class="w-0 h-[1px] bg-black mx-auto mt-2 transition-all duration-700 peer-checked:w-6">
                                </div>
